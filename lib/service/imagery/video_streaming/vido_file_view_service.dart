...
class VideoFileViewService {
  final String baseUrl = Urls.viewVideoListEndPoint;

  Future<List<VideoFileViewModel>?> getVideoList({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData != null && responseData['Details'] != null) {
          ...
          final List<VideoFileViewModel> mediaFiles = details
              .map<VideoFileViewModel>((item) =>
                  VideoFileViewModel.fromJson(item as Map<String, dynamic>))
              .toList();
